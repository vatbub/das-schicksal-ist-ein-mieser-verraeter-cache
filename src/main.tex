...
\begin{document}
    ...
    \begin{scene}{aussen}{Fahrt zu Augustus}{Nachmittag}
        ...
        \actionline{\gls{Augustus} hält abrupt vor einer Ampel an und weicht dabei gerade so seinem Vordermann aus, weil \gls{Augustus} sonst nicht rechtzeitig zum Stehen kam.}
        ...
        \begin{decision}{hazel-fragt-nach-lebenserwartung}{\gls{Hazel} fragt nach \gls{Augustus} Lebenserwartung.}{Hazel}
            ...
            \begin{option}{hazel-fragt-nach-lebenserwartung-direkt}{Wie ist deine Lebenserwartung?}
                ...
                \begin{dialog}[verärgert]{Augustus}
                    ...
                    \direction{etwas weniger verärgert}
        ...
        \actionline{\gls{Augustus} biegt auf seine Hofeinfahrt ein und räumt dabei die Mülltonnen des Nachbarn ab.}
